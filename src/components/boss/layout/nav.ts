...
export type PageMeta = {
  ...
  /** 본문 최대 폭 — 참조: narrow 620 / wide 860 / full 1560. 기본 full */
  width?: PageWidth;
...
const PAGE_META: Record<string, PageMeta> = {
  ...
  '/boss/calendar': { title: '일정', subtitle: '시공 · 견적 방문 예약을 관리합니다.' },
  '/boss/calendar/day': { title: '일별 일정', subtitle: '하루 단위로 봅니다.' },
  '/boss/calendar/week': { title: '주간 일정', subtitle: '한 주 단위로 봅니다.' },
  ...
  '/boss/construction/new': { title: '새 시공 기록', subtitle: '현장 정보를 입력합니다.', width: 'wide' },
  '/boss/checklist': {
    title: '체크리스트',
  ...
  '/boss/community/new': { title: '글쓰기', subtitle: '커뮤니티 게시글을 작성합니다.', width: 'wide' },
  '/boss/community/my': { title: '내 글', subtitle: '작성한 게시글입니다.' },
  '/boss/community/jobs': { title: '구인 / 구직', subtitle: '인력을 구하거나 일자리를 찾습니다.' },
  '/boss/community/blocks': { title: '차단 관리', subtitle: '차단한 사용자 목록입니다.', width: 'wide' },
  '/boss/ads': { title: '지도 광고', subtitle: '지도 노출 설정과 성과를 봅니다.' },
  '/boss/events': { title: '이벤트', subtitle: '진행 중인 혜택입니다.' },

  '/boss/billing': { title: '구독 · 결제', subtitle: '플랜과 결제 수단을 관리합니다.', width: 'wide' },
  '/boss/billing/plans': { title: '요금제', subtitle: '플랜을 비교하고 변경합니다.', width: 'wide' },
  '/boss/billing/history': { title: '결제 내역', subtitle: '지난 결제 기록입니다.', width: 'wide' },
  '/boss/billing/renewals': { title: '갱신 관리', subtitle: '자동 갱신을 설정합니다.', width: 'wide' },
  '/boss/billing/status': { title: '구독 상태', subtitle: '현재 플랜 정보입니다.', width: 'wide' },
  '/boss/settings': { title: '설정', subtitle: '계정 · 알림 · 약관을 관리합니다.' },
  '/boss/settings/alarm': { title: '알림 설정', subtitle: '수신 항목을 선택합니다.', width: 'wide' },
  '/boss/settings/notifications': { title: '푸시 알림', subtitle: '기기별로 설정합니다.', width: 'wide' },
  '/boss/settings/privacy': { title: '개인정보 처리방침', width: 'wide' },
  '/boss/settings/terms': { title: '이용약관', width: 'wide' },
  '/boss/settings/faq': { title: '자주 묻는 질문', subtitle: '도움말', width: 'wide' },

  '/boss/me': { title: '내 정보', subtitle: '프로필과 계정 정보입니다.', width: 'wide' },
  '/boss/me/edit': { title: '정보 수정', subtitle: '프로필을 변경합니다.', width: 'wide' },
  '/boss/me/company': { title: '회사 정보', subtitle: '사업자 · 시공 범위를 관리합니다.', width: 'wide' },
  ...
  '/boss/onboarding': { title: '시작하기', subtitle: '초기 설정을 진행합니다.', width: 'wide' },
...
export function getPageMeta(pathname: string | null): PageMeta {
  ...
  return {
    ...
    width: parent.width,
    back: parentKey === '/boss' ? undefined : { label: parent.title, href: parentKey },
  };
}
