...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, onLoginSuccess, onSwitchToRegister }) => {
  ...
  const handleNaverLogin = async () => {
    try {
      ...
      toast.error('Naver 로그인을 시작할 수 없습니다.', {
        duration: 3000,
        position: 'top-center',
      });
    }
              ...
              <div className="flex flex-col items-center mb-6 sm:mb-8">
                ...
                <div className="grid grid-cols-3 gap-3 w-full">
                  ...
                  <motion.button
                    ...
                    type="button"
                    className="flex items-center justify-center p-3 bg-white/10 hover:bg-white/20 border border-slate-600 rounded-xl transition-all duration-200"
                    title="Google로 시작하기"
                  >
                  ...
                  <motion.button
                    ...
                    type="button"
                    className="flex items-center justify-center p-3 bg-[#FEE500]/10 hover:bg-[#FEE500]/20 border border-[#FEE500]/30 rounded-xl transition-all duration-200"
                    title="카카오로 시작하기"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24px" height="24px">
                  ...
                  <motion.button
                    ...
                    type="button"
                    className="flex items-center justify-center p-3 bg-[#03C75A]/10 hover:bg-[#03C75A]/20 border border-[#03C75A]/30 rounded-xl transition-all duration-200"
                    title="네이버로 시작하기"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24px" height="24px">
