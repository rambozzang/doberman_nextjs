    ...
    questions: [
      {
        ...
        // 근거 없는 수치("전국 200명", "최대 5개")를 뺐다. 실측상 한 요청에 도착한
        // 견적은 최대 1개이고, 전문가 수 200명도 확인되지 않는다.
        answer: "도배르만은 도배 전문가와 고객을 연결해주는 비교견적 서비스입니다. 한 번의 요청으로 여러 전문가에게 무료로 견적을 받아보고 비교할 수 있습니다."
      },
      {
        id: "service-2",
      ...
      },
      {
        id: "service-3",
        question: "어떻게 이용하나요?",
        answer: "1) 간단한 정보 입력으로 견적 요청 → 2) 도착한 전문가 견적 확인 → 3) 견적 비교 → 4) 마음에 드는 전문가 선택 → 5) 직접 연락 후 시공 진행 순으로 이용하실 수 있습니다."
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        // "평균 2-6시간", "24시간 내 모든 견적 완료" 는 실측(첫 응답 평균 14.5시간,
        // 요청의 상당수는 답변이 오지 않음)과 맞지 않아 보장 표현을 뺐다.
        answer: "견적이 도착하는 시간은 지역과 시공 규모, 전문가의 일정에 따라 다릅니다. 보통 하루 안에 첫 견적을 받아보시며, 요청 내용이 구체적일수록 더 빠르게 회신되는 편입니다."
      },
      {
        id: "quote-2",
        question: "몇 개의 견적을 받을 수 있나요?",
        answer: "요청 내용을 확인한 전문가들이 견적을 보내드립니다. 도착한 견적의 가격, 서비스 범위, 경력 등을 비교해 보시고 선택하세요. 견적 수는 지역과 시공 조건에 따라 달라질 수 있습니다."
      },
      {
        id: "quote-3",
        question: "견적이 정확한가요?",
