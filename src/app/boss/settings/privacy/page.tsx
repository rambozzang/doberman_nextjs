// 개인정보 처리방침 — Industry 패턴
//
//   패널 하나: kicker(시행일) → 조항 제목 14px 700 + 본문 13.5px / 1.75.
//   화면 제목은 헤더(PAGE_META)가 그린다. /boss/help/privacy 도 이 화면을 그대로 쓴다.
//
// Flutter 원본: lib/app/setting/privecy_page.dart
// 원본은 https://www.codelabtiger.com/doberman/privacy/index.html 를 WebView로 표시. 여기서는 정적 텍스트.
