      ...
      <div className="relative grid min-h-screen lg:grid-cols-2">
        ...
        <section className="flex items-center justify-center px-6 py-12 sm:px-12">
          <div className="w-full max-w-sm">
            ...
            <div className="mb-7">
              <h2 className="text-2xl font-bold tracking-tight text-white">아이디 찾기</h2>
            ...
            {foundId && (
              <div className="mt-6 rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-4">
                ...
                <p className="mt-1 text-base font-bold text-white">{foundId}</p>
                <Link
                  href="/boss/login"
            ...
            <p className="mt-6 text-center text-[11px] text-slate-500">
              비밀번호를 잊으셨나요?{' '}
              <Link href="/boss/find-password" className="font-medium text-emerald-400 hover:text-emerald-300">
                비밀번호 찾기
              </Link>
            </p>
          </div>
