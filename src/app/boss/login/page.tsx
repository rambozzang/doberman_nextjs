          ...
          <div className="space-y-8">
            <div>
              <div className="mb-3 inline-flex items-center gap-1.5 rounded-full border border-boss-primary/20 bg-boss-primary/5 px-3 py-1">
                ...
                <span className="text-[11px] font-medium text-boss-primary">전국 300+ 검증된 사장님</span>
              </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={label} className="flex items-center gap-3 text-sm text-boss-text-secondary">
                  <div className="flex h-8 w-8 items-center justify-center rounded-lg border border-boss-primary/20 bg-boss-primary/5">
          ...
          <div className="w-full max-w-sm">
            <div className="mb-8 lg:hidden">
              <Link href="/boss" className="flex items-center gap-2">
                <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-400 to-boss-primary-hover">
                  <Building2 size={16} className="text-boss-text" />
                </div>
                <span className="text-base font-bold text-boss-text">도배르만 PRO</span>
              </Link>
            </div>

            <div className="mb-7">
              <h2 className="text-2xl font-bold tracking-tight text-boss-text">사장님 로그인</h2>
              <p className="mt-2 text-sm text-boss-text-muted">
                계정이 없으신가요?{' '}
                <Link href="/boss/signup" className="font-medium text-boss-primary hover:text-boss-primary">
                  무료로 시작하기
                </Link>
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-lg border border-boss-border bg-boss-surface pl-10 pr-3 text-sm text-boss-text placeholder:text-boss-text-muted transition-colors focus:border-boss-primary/50 focus:bg-boss-surface focus:outline-none focus:ring-2 focus:ring-boss-primary/10"
              ...
              <div>
                <div className="mb-1.5 flex items-center justify-between">
                  <label htmlFor="password" className="block text-xs font-medium text-boss-text-secondary">
                    비밀번호
                  </label>
                  <Link
                    href="/boss/find-password"
                    className="text-[11px] font-medium text-boss-text-muted hover:text-boss-primary"
                  >
                    비밀번호 찾기
                  </Link>
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-lg border border-boss-border bg-boss-surface pl-10 pr-10 text-sm text-boss-text placeholder:text-boss-text-muted transition-colors focus:border-boss-primary/50 focus:bg-boss-surface focus:outline-none focus:ring-2 focus:ring-boss-primary/10"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              <label className="flex cursor-pointer items-center gap-2 select-none">
                <span className="relative">
                  ...
                  />
                  <span className="block h-4 w-4 rounded border border-boss-border bg-boss-surface peer-checked:border-emerald-500 peer-checked:bg-boss-primary" />
                  <CheckCircle2
                    size={12}
                    className="pointer-events-none absolute left-0.5 top-0.5 text-boss-text opacity-0 peer-checked:opacity-100"
                  />
                </span>
              ...
              <button
                type="submit"
                disabled={loading}
                className="group relative flex h-11 w-full items-center justify-center gap-2 overflow-hidden rounded-lg bg-gradient-to-r from-boss-primary to-boss-primary-hover text-sm font-semibold text-boss-text shadow-boss-md transition-all hover:from-boss-primary-hover hover:to-boss-primary hover:shadow-emerald-500/30 disabled:cursor-not-allowed disabled:from-slate-700 disabled:to-slate-700 disabled:shadow-none"
              >
                {loading ? (
            ...
            <div className="mt-6 flex items-center gap-3">
              <span className="h-px flex-1 bg-boss-elevated" />
            ...
            <Link
              href="/boss/find-id"
              className="mt-6 flex h-11 w-full items-center justify-center rounded-lg border border-boss-border bg-boss-surface text-sm font-medium text-boss-text-secondary transition-colors hover:border-boss-border hover:bg-boss-surface hover:text-boss-text"
            >
              아이디 찾기
            </Link>
            ...
            <p className="mt-8 text-center text-[11px] text-boss-text-muted">
              로그인 시{' '}
              <Link href="/boss/help/terms" className="text-boss-text-muted underline hover:text-boss-text">
                이용약관
              </Link>
              과{' '}
              <Link href="/boss/help/privacy" className="text-boss-text-muted underline hover:text-boss-text">
                개인정보처리방침
              </Link>
              에 동의하게 됩니다.
            </p>
