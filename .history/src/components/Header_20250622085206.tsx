    ...
    <>
      ...
      >
        <div className="container mx-auto" style={{ padding: '0 var(--spacing-4)' }}>
          <div className="flex items-center justify-between" style={{ height: 'var(--spacing-16)', '@media (min-width: 1024px)': { height: 'var(--spacing-20)' } }}>
            {/* Logo */}
            <motion.div
            ...
            >
              <Link href="/" className="flex items-center space-x-3 group">
                ...
                <div className="hidden sm:block">
                  ...
                  <div className="text-xs text-slate-400 -mt-1">Professional Service</div>
                </div>
              </Link>
            </motion.div>
            ...
            <div className="hidden lg:flex items-center justify-center flex-1 px-8">
              <nav className="flex items-center space-x-2 bg-slate-800/50 backdrop-blur-sm rounded-2xl p-2 border border-slate-700/50">
                {navigationItems.map((item, index) => (
                  ...
                  >
                    <Link
                      href={item.href || "#"}
                      className="group relative flex items-center space-x-2 px-4 py-2.5 rounded-xl text-slate-300 hover:text-white transition-all duration-300 hover:bg-slate-700/50"
                    >
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              >
                <Link
                  href={ctaHref}
                  className="group relative inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2.5 rounded-xl text-sm font-semibold shadow-lg hover:shadow-blue-500/25 transition-all duration-300 overflow-hidden"
                >
              ...
              {showAuth && (
                <motion.button
                  ...
                  className="flex items-center space-x-2 text-slate-300 hover:text-white px-4 py-2.5 rounded-xl border border-slate-700/50 hover:border-slate-600/50 hover:bg-slate-800/50 transition-all duration-300"
                >
          ...
          {isMobileMenuOpen && (
            <>
              ...
              <motion.div
                ...
                transition={{ duration: 0.2 }}
                className="absolute top-full left-4 right-4 mt-2 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl z-50 overflow-hidden"
              >
