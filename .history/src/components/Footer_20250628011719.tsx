        ...
        <div className="py-6 sm:py-8 lg:py-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
              ...
              >
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="p-2 sm:p-2.5 rounded-lg bg-accent/50 text-muted-foreground hover:text-foreground hover:bg-accent transition-colors touch-target"
            ...
            <div className="md:col-span-2 lg:col-span-6">
              {/* 데스크톱 버전 - 기존 그리드 */}
              <div className="hidden md:grid grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                    ...
                    <ul className="space-y-2 sm:space-y-3">
                      {section.links.map((link) => (
                        <li key={link.title}>
                          <Link
                            href={link.href}
                            className="text-xs sm:text-sm text-muted-foreground hover:text-foreground transition-colors block py-1 touch-target"
                          >
                            {link.title}
                          </Link>
                        </li>
