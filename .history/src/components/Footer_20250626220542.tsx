...
import { Github, Twitter, Linkedin, Mail, Phone, MapPin, ChevronDown, ChevronUp } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-8 sm:py-12 lg:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
            {/* Company Info */}
            <div className="md:col-span-2 lg:col-span-4 space-y-4 sm:space-y-6">
              <motion.div
              ...
              >
                <Link href="/" className="flex items-center space-x-2 mb-3 sm:mb-4">
                  ...
                  <span className="text-lg sm:text-xl font-bold text-foreground">{logo}</span>
                </Link>
                <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed pr-4">
                  {description}
                </p>
              </motion.div>
            ...
            {/* Footer Links */}
            <div className="md:col-span-2 lg:col-span-6 grid grid-cols-2 gap-4 sm:gap-6 md:gap-8">
