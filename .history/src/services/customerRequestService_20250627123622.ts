...
export class CustomerRequestService {
  ...
  // 답변 채택 API
  static async adoptAnswer(requestId: number, answerId: number): Promise<ApiResponse<any>> {
    return await ApiClient.postPrivate<any>(`/web/customer-request/selectWebRequestAnswer/${requestId}/${answerId}`, {});
  }
} 