          ...
          <div className="relative">
            ...
            <div className="relative card-enhanced text-center border-gradient">
              ...
              >
                ...
                <p className="text-body-lg text-subtle mb-8 max-w-2xl mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-6 mt-8">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-caption text-muted">100% 무료</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full animate-pulse"></div>
                    <span className="text-caption text-muted">로그인 불필요</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-accent rounded-full animate-pulse"></div>
                    <span className="text-caption text-muted">3분 소요</span>
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        >
          <div className="grid-responsive-4">
            ...
            <motion.div
              ...
              className="card text-center hover:glow-effect"
            >
              <div className="flex items-center justify-center gap-3 mb-2">
                <Eye className="w-5 h-5 text-accent" />
                <span className="text-caption text-muted font-medium">오늘 방문자</span>
              </div>
              <div className="text-h4 font-bold text-white">998명</div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <span className="text-caption text-muted font-medium">총 게시물</span>
              </div>
              <div className="text-h4 font-bold text-white">1,420개</div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <span className="text-caption text-muted font-medium">전체 회원수</span>
              </div>
              <div className="text-h4 font-bold text-white">850명</div>
            </motion.div>
