            ...
            <div className="relative card-enhanced text-center border-gradient">
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full md:w-auto px-12 py-6 text-lg md:text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl group relative overflow-hidden shadow-2xl hover:shadow-blue-500/25 transition-all duration-300"
