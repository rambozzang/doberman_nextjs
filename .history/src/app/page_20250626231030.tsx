      ...
      <div className="container mx-auto page-wrapper">
        ...
        >
          <div className="absolute inset-0 flex items-center">
            ...
            >
              {/* 도배업체명들 - 첫 번째 세트 */}
              <span className="text-slate-300 font-medium text-sm">김도배 전문가</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">이인테리어</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">박마스터</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">최프로</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">정장인</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">서울도배</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">부산인테리어</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">대구도배마스터</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">인천프로</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">경기도배</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">강남인테리어</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">홍도배</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">전문가그룹</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">마스터도배</span>
              <span className="text-slate-400">•</span>
              <span className="text-slate-300 font-medium text-sm">프리미엄인테리어</span>
