          ...
          <div className="relative max-w-2xl w-full">
            ...
            <div className="relative card-enhanced text-center border-gradient">
              ...
              >
                ...
                >
                  {/* 버튼 내부 애니메이션 효과 */}
                  <div className="absolute inset-0 bg-gradient-to-r p-2 from-white/0 via-white/20 to-white/0 -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
