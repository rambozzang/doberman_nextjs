    ...
    <div className="main-layout">
      <div className="container-custom page-wrapper px-4 sm:px-6 md:px-8">
        ...
        <motion.div
          ...
          className="relative text-center px-4 py-16 sm:py-20 md:py-24 lg:py-32 overflow-hidden"
        >
          {/* 배경 장식 요소들 */}
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-purple-200 mb-6 leading-tight tracking-tight"
            >
              무료 도배 비교
              <br />
