...
export default function ChecklistPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* 헤더 */}
      <section className="w-full bg-gradient-to-br from-slate-900 via-indigo-900/50 to-purple-900/50 relative overflow-hidden pt-12">
        {/* 배경 효과 */}
        ...
        <div className="container mx-auto px-4 py-8 md:py-12 relative">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl mb-4 shadow-2xl shadow-indigo-500/25"
            >
              <ClipboardListIcon className="w-5 h-5 md:w-6 md:h-6 text-white" />
            </motion.div>
            ...
            <motion.p
              ...
              className="text-sm md:text-base text-slate-300 mb-4 max-w-2xl mx-auto leading-relaxed"
            >
            ...
            >
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-4">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-white font-semibold text-sm">전체 진행률</span>
                  <span className="text-indigo-300 font-bold text-sm">{getTotalProgress()}%</span>
                </div>
