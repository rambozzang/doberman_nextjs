      ...
      <section className="w-full bg-gradient-to-br from-slate-900 via-indigo-900/50 to-purple-900/50 relative overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 relative">
          ...
          >
            ...
            >
              <ClipboardListIcon className="w-8 h-8 md:w-10 md:h-10 text-white" />
            </motion.div>
            ...
            >
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-indigo-300 font-bold text-lg">{getTotalProgress()}%</span>
                </div>
      ...
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            >
              <div className="sticky top-8 space-y-4">
                <h3 className="text-lg font-bold text-white mb-6">체크리스트 단계</h3>
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-4 py-3 bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white font-semibold rounded-xl shadow-lg transition-all duration-300"
                  >
                  ...
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-4 py-3 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl border border-white/20 hover:border-white/40 backdrop-blur-sm transition-all duration-300"
                  >
                    <div className="flex items-center justify-center">
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center mb-4">
                        <div className={`w-12 h-12 bg-gradient-to-br ${currentCategory.color} rounded-xl flex items-center justify-center mr-4 shadow-lg`}>
                          {(() => {
                        ...
                        <div>
                          <h2 className="text-2xl font-bold text-white mb-1">{currentCategory.title}</h2>
                              ...
                              <AnimatePresence>
                                {checkedItems[item.id] && (
                                  <motion.div
                                    ...
                                    className={`ml-4 px-3 py-1 bg-gradient-to-r ${currentCategory.color} rounded-full`}
                                  >
        ...
        >
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-amber-500/25">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                {[
                  ...
                  return (
                    ...
                    >
                      <div className={`w-12 h-12 bg-gradient-to-br ${tip.color} rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg`}>
