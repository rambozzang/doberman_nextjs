...
import { Plus, Minus, User, Github, Zap, Layers, Play, ExternalLink, ArrowRight, HelpCircle, CheckSquare, MapPin, Eye, FileText, Users, MessageCircle, Star, MapPin as Location, Phone, Award, Clock } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4 pt-28 lg:pt-32 pb-16">
        
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="hero-section text-center mb-16 p-12"
        >
          <h1 className="text-5xl font-bold text-slate-900 dark:text-slate-100 mb-4">
            🐕 무료 도배 비교 견적 서비스
          </h1>
          <p className="text-xl text-slate-600 dark:text-slate-400 mb-8">
            전국 200명 이상의 도배 전문가들과 한께하는 도배 비교견적 플랫폼
          </p>
        ...
        >
          <div className="relative">
            ...
            {/* 메인 CTA 카드 */}
            <div className="relative bg-gradient-to-r from-slate-800/90 to-slate-900/90 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-12 text-center">
              <motion.div
                initial={{ scale: 0.9 }}
                animate={{ scale: 1 }}
              ...
              >
                ...
                <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
                  3분만 투자하면 최대 5개 업체의 견적을 무료로 받아보세요
                </p>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="group relative inline-flex items-center justify-center px-12 py-6 text-xl font-bold text-white overflow-hidden rounded-2xl transition-all duration-300"
                  style={{
                ...
                >
                  ...
                  {/* 버튼 테두리 글로우 */}
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm -z-10"></div>
                </motion.button>
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -right-4 w-6 h-6 bg-gradient-to-r from-pink-400 to-orange-400 rounded-full opacity-60"
            ></motion.div>
            ...
            <motion.div
              ...
              className="absolute top-1/2 -right-8 w-4 h-4 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full"
            ></motion.div>
          </div>
        </motion.div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <motion.div
              ...
              className="bg-slate-800/60 backdrop-blur-sm border border-slate-700/50 rounded-xl p-3 text-center hover:bg-slate-800/80 transition-all duration-300"
            >
              <div className="flex items-center justify-center gap-3 mb-2">
                <Eye className="w-5 h-5 text-slate-400" />
                <span className="text-slate-400 text-sm font-medium">오늘 방문자</span>
              </div>
              <div className="text-xl font-bold text-white">998명</div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <span className="text-slate-400 text-sm font-medium">총 게시물</span>
              </div>
              <div className="text-xl font-bold text-white">1,420개</div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <span className="text-slate-400 text-sm font-medium">전체 회원수</span>
              </div>
              <div className="text-xl font-bold text-white">850명</div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <span className="text-slate-400 text-sm font-medium">오늘 댓글</span>
              </div>
              <div className="text-xl font-bold text-white">32개</div>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.6 }}
              className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 text-center hover:bg-slate-800/70 transition-all duration-300"
            >
