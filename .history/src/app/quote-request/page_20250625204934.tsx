                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 md:gap-3">
                            {regions.map((region) => (
                              ...
                              >
                                {formState.region === region.value && (
                                  <div className="absolute  top-2 right-1 md:top-6 md:right-2 w-5 h-5 md:w-6 md:h-6 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg">
                                    <CheckIcon className="w-2.5 h-2.5 md:w-3 md:h-3 text-white" />
                                  </div>
                                )}
