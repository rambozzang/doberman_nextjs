...
export default function QuoteRequestPage() {
  ...
  return (
    <div className="min-h-screen quote-request-bg">
      {/* 헤더 */}
      <div 
        className="quote-header relative overflow-hidden rounded-lg"
        style={{
        ...
        <div className="container-custom relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="mb-4 sm:mb-0">
              <h1 className="text-3xl font-bold text-white drop-shadow-lg">무료 견적 요청하기</h1>
              <p className="mt-2 text-slate-200 drop-shadow-md">
      ...
      <div className="container-custom page-wrapper">
        <div className="grid-responsive-2 items-start">
          ...
          <div className="hidden lg:block">
            <div className="card-enhanced sticky ">
          ...
          <div className="lg:col-span-1 col-span-full">
            <div className="card-enhanced">
              <form onSubmit={handleSubmit}>
                ...
                {/* 네비게이션 버튼 */}
                <div className="flex justify-between items-center border-t border-slate-600" style={{ paddingTop: 'var(--spacing-6)' }}>
                  <button
                    type="button"
                    onClick={prevStep}
