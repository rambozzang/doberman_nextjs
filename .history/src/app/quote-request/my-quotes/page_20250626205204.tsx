              ...
              <div className="space-y-4">
                {filteredRequests.map((request) => {
                  ...
                  return (
                    <div
                      key={request.id}
                      className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg p-4 hover:border-white/20 hover:scale-[1.005] hover:-translate-y-0.5 transition-all duration-300"
                    >
                      <div className="grid grid-cols-1 lg:grid-cols-4 gap-3">
                        ...
                        <div className="flex lg:flex-col gap-2">
                          ...
                          {/* 고객 정보 */}
                          <div className="bg-slate-800/30 rounded-lg p-3 flex-1 lg:flex-none text-center">
                            <div className="text-sm text-slate-400">고객</div>
                            <div className="text-sm text-white font-medium truncate">{request.customerName}</div>
                          </div>
                          ...
                          <div className="flex lg:flex-col gap-2">
                            <Link 
                              ...
                              className="flex items-center justify-center gap-2 px-4 py-2 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-lg transition-all text-blue-400 hover:text-blue-300 text-sm whitespace-nowrap"
                            >
                            ...
                            {request.status === '검토중' && (
                              <>
                                <button className="flex items-center justify-center gap-2 px-4 py-2 bg-slate-700/50 hover:bg-slate-700/70 border border-slate-600 rounded-lg transition-all text-slate-300 hover:text-white text-sm whitespace-nowrap">
                                  <EditIcon className="w-4 h-4" />
                                  수정
                                </button>
                                <button 
                                  onClick={() => handleDelete(request.id)}
                                  className="flex items-center justify-center gap-2 px-4 py-2 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 rounded-lg transition-all text-red-400 hover:text-red-300 text-sm whitespace-nowrap"
                                >
