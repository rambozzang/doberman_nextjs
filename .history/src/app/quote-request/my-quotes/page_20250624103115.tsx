                          ...
                          <div className="mb-3">
                            <div className="flex flex-wrap gap-2">
                              {request.constructionScope.map((scope, idx) => (
                                <span key={idx} className="px-2 py-1 bg-slate-700/50 text-xs text-slate-300 rounded-md">
                                  {scope}
                                </span>
                              ))}
                            </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="bg-slate-800/30 rounded-lg p-3">
                            <div className="text-center mb-2">
                              <div className="text-xl font-bold text-blue-400">{request.quotesReceived}</div>
                              <div className="text-xs text-slate-400">받은 견적</div>
                            </div>
                            
                            {request.budget && (
                              <div className="text-center">
                                <div className="text-xs text-slate-400 mb-1">예상 예산</div>
                          ...
                          {request.messages > 0 && (
                            <div className="bg-slate-800/30 rounded-lg p-3">
                              <div className="flex items-center justify-center gap-2 text-blue-400">
                                ...
                                <span className="font-semibold text-sm">{request.messages}</span>
                                <span className="text-slate-400 text-xs">개의 메시지</span>
                              </div>
                            </div>
                          )}
                          ...
                          {request.estimatedCompletion && (
                            <div className="bg-slate-800/30 rounded-lg p-3">
                              <div className="text-center">
                                <div className="text-xs text-slate-400 mb-1">완료 예정</div>
                                <div className="text-sm text-white font-semibold">{request.estimatedCompletion}</div>
                              </div>
                            </div>
                          )}
