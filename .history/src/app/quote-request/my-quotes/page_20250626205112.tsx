              ...
              <div className="space-y-4">
                {filteredRequests.map((request) => {
                  ...
                  return (
                    <div
                      key={request.id}
                      className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg p-1.5 hover:border-white/20 hover:scale-[1.005] hover:-translate-y-0.5 transition-all duration-300"
                    >
                      <div className="grid grid-cols-1 lg:grid-cols-4 gap-1.5">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-1.5">
                                ...
                                <div className={`flex items-center gap-1 px-1.5 py-0.5 rounded text-xs font-medium ${statusConfig.bgColor} ${statusConfig.textColor}`}>
                        ...
                        <div className="flex lg:flex-col gap-1">
                          {/* 견적 정보 */}
                          <div className="bg-slate-800/30 rounded p-1 flex-1 lg:flex-none text-center">
                            <div className="text-sm font-bold text-blue-400">{request.answerCount}</div>
                          ...
                          <div className="flex lg:flex-col gap-0.5">
                            <Link 
                              ...
                              className="flex items-center justify-center gap-1 px-1.5 py-0.5 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded transition-all text-blue-400 hover:text-blue-300 text-xs whitespace-nowrap"
                            >
                            ...
                            {request.status === '검토중' && (
                              <>
                                <button className="flex items-center justify-center gap-1 px-1.5 py-0.5 bg-slate-700/50 hover:bg-slate-700/70 border border-slate-600 rounded transition-all text-slate-300 hover:text-white text-xs whitespace-nowrap">
                                  <EditIcon className="w-2.5 h-2.5" />
                                  수정
                                </button>
                                <button 
                                  onClick={() => handleDelete(request.id)}
                                  className="flex items-center justify-center gap-1 px-1.5 py-0.5 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 rounded transition-all text-red-400 hover:text-red-300 text-xs whitespace-nowrap"
                                >
