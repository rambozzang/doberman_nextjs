      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-900 to-slate-800">
        <div className="container mx-auto px-4 py-8 flex-grow flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-slate-300">인증 상태를 확인하는 중...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="container mx-auto px-4 py-8 flex-grow flex items-center justify-center">
          <div className="text-center max-w-md">
            ...
            <p className="text-slate-400 mb-6">
              내 견적 요청을 확인하려면 로그인해주세요.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/"
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg transition-all duration-300"
              >
                로그인하기
              </Link>
              <Link
                href="/quote-request/list"
                className="px-6 py-3 bg-slate-700/50 hover:bg-slate-600/50 border border-slate-600 rounded-xl transition-all text-slate-300 hover:text-white"
              >
                전체 견적 보기
              </Link>
            </div>
