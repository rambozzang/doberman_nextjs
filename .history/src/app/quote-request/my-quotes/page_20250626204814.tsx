              ...
              <div className="space-y-4">
                {filteredRequests.map((request) => {
                  ...
                  return (
                    <div
                      key={request.id}
                      className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-3 hover:border-white/20 hover:scale-[1.01] hover:-translate-y-0.5 transition-all duration-300"
                    >
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
                        ...
                        <div className="lg:col-span-2">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                            <div className="space-y-1">
                              <div className="flex items-center text-xs text-slate-300">
                                <BuildingIcon className="w-3 h-3 mr-1.5 text-slate-400" />
                          ...
                          {request.wallpaper && (
                            <div className="mb-2">
                              <div className="flex flex-wrap gap-1">
                                <span className="px-2 py-0.5 bg-slate-700/50 text-xs text-slate-300 rounded">
                          ...
                          {request.specialInfo && (
                            <div>
                              <p className="text-xs text-slate-300 line-clamp-2">{request.specialInfo}</p>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="bg-slate-800/30 rounded-lg p-2">
                            <div className="text-center mb-1">
                              <div className="text-lg font-bold text-blue-400">{request.answerCount}</div>
                          ...
                          <div className="bg-slate-800/30 rounded-lg p-2">
                            <div className="text-center">
                              <div className="text-xs text-slate-400 mb-0.5">고객명</div>
                          ...
                          <div className="space-y-1.5">
                            <Link 
                              ...
                              className="w-full flex items-center justify-center gap-1.5 px-3 py-1.5 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-lg transition-all text-blue-400 hover:text-blue-300 text-xs"
                            >
                            ...
                            {request.status === '검토중' && (
                              <div className="grid grid-cols-2 gap-1">
                                <button className="flex items-center justify-center gap-1 px-2 py-1 bg-slate-700/50 hover:bg-slate-700/70 border border-slate-600 rounded transition-all text-slate-300 hover:text-white text-xs">
                                  <EditIcon className="w-3 h-3" />
                                  수정
                                </button>
                                <button 
                                  onClick={() => handleDelete(request.id)}
                                  className="flex items-center justify-center gap-1 px-2 py-1 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 rounded transition-all text-red-400 hover:text-red-300 text-xs"
                                >
