                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 md:gap-3">
                            {regions.map((region) => (
                              <div
                                key={region.value}
                                className={`group relative   md:px-2 border-2 rounded-lg md:rounded-xl cursor-pointer transition-all duration-300 min-h-[80px] hover:scale-105 hover:-translate-y-1 ${
