                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-3 md:gap-4">
                            {regions.map((region) => (
                              <div
                                key={region.value}
                                className={`group relative p-1 md:p-4 border-2 rounded-lg md:rounded-xl cursor-pointer transition-all duration-300 min-h-[80px] hover:scale-105 hover:-translate-y-1 ${
