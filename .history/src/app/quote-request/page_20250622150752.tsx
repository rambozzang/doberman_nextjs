...
export default function QuoteRequestPage() {
  ...
  return (
    <div className="min-h-screen quote-request-bg">
      ...
      {/* Rules 섹션 */}
      <div className="bg-slate-800/30 border-y border-white/10 py-4">
        <div className="container-custom">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs md:text-sm text-slate-300">
            <div className="flex items-center">
