...
import { CustomerRequest, CustomerRequestSearchRequest } from "@/types/api";
...
export default function QuoteRequestListPage() {
  ...
  const loadCustomerRequests = useCallback(async (
    ...
    try {
      const params: CustomerRequestSearchRequest = { page, size, signal };
  ...
  useEffect(() => {
    ...
    loadCustomerRequests(0, pageSize, "", "all", "all", sortBy, sortOrder, controller.signal);
    return () => {
      controller.abort();
    };
