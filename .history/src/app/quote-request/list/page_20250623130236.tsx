      ...
      <section className="w-full bg-gradient-to-br from-slate-900 via-blue-900/50 to-purple-900/50 relative overflow-hidden pt-16">
        ...
        <div className="container mx-auto px-4 py-12 md:py-20 relative">
          ...
          >
            ...
            >
              모든 견적 요청을 한눈에 확인하고 관리하세요. 상태별, 지역별로 필터링하여 효율적으로 업무를 처리할 수 있습니다.
            </motion.p>
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            ...
                            <h3 className="text-lg font-bold text-white mb-1 line-clamp-2">{request.title}</h3>
                          </div>
                          
                          <div className={`flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium ${statusConfig[request.status].bgColor} ${statusConfig[request.status].textColor}`}>
                        ...
                        <div className="space-y-3 mb-4">
                          <div className="flex items-center text-sm text-slate-300">
                            ...
                            <span>{request.area.pyeong}평 ({request.area.squareMeter}㎡)</span>
                          </div>
                          ...
                          <div className="flex items-center text-sm text-slate-300">
                            ...
                            {request.visitDate && (
                              <>
                                <span className="mx-2">•</span>
                                <span>방문일: {request.visitDate}</span>
                              </>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="mb-4">
                          <div className="flex flex-wrap gap-1">
                            {request.constructionScope.map((scope, idx) => (
                              <span key={idx} className="px-2 py-1 bg-slate-700/50 text-xs text-slate-300 rounded-lg">
                                {scope}
                              </span>
                            ))}
                          </div>
                        ...
                        <div className="flex gap-2">
                          <Link 
                            ...
                            className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 rounded-xl transition-all text-blue-400 hover:text-blue-300"
                          >
