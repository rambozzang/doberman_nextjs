      ...
      <section className="quote-rules-section w-full h-[120px] bg-gradient-to-r from-slate-900/60 via-indigo-900/40 to-purple-900/60 border-y border-white/10 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 h-full flex items-center">
          <div className="w-full">
            <div className="text-center mb-6">
              <h3 className="text-sm md:text-base font-bold text-white mb-1 hover:scale-105 transition-transform duration-300">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 md:gap-6 text-xs md:text-sm">
              {[
                ...
                <div
                  key={index}
                  className="group relative hover:scale-108 hover:-translate-y-0.5 transition-all duration-300"
                >
                  <div className="relative flex items-center bg-white/5 backdrop-blur-lg rounded-full px-4 py-2.5 border border-white/20 hover:border-white/40 transition-all duration-300 hover:bg-white/10 cursor-pointer">
                    ...
                    <div className="relative mr-3">
                      <div className={`w-2.5 h-2.5 rounded-full bg-gradient-to-r ${item.color} ${item.shadowColor} shadow-lg animate-pulse`} />
                    </div>
                    ...
                    {/* 호버 시 반짝이는 효과 */}
                    <div className="absolute -top-1 -right-1 w-2 h-2 bg-white/40 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  </div>
                </div>
              ))}
            </div>
