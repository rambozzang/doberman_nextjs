...
export default function QuoteRequestPage() {
  ...
  if (isComplete) {
    return (
      <div className="quote-request-bg min-h-screen flex items-center justify-center py-8 md:py-12 px-4">
        <motion.div
  ...
  return (
    <div className="quote-request-bg min-h-screen pt-20">
      {/* 견적 요청 전용 헤더 */}
      <div 
        className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900"
      ...
      {/* Rules 섹션 */}
      <section className="bg-gradient-to-r from-slate-800/40 via-slate-700/30 to-slate-800/40 border-y border-white/10 py-4 md:py-6">
