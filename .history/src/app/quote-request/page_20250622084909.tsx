      ...
      <div className="container-custom page-wrapper">
        <div className="grid-responsive-2">
            ...
            <div>
              ...
              <div className="mb-6">
                <h2 className="text-h4 font-semibold text-white mb-2">무료 견적 요청</h2>
                  ...
                  >
                    ...
                    <div style={{ marginBottom: 'var(--spacing-8)' }}>
                      ...
                      {currentStep === 4 && (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)' }}>
                          <div>
                            <h4 className="text-lg font-semibold text-gray-900" style={{ marginBottom: 'var(--spacing-4)' }}>추가 서비스 (선택사항)</h4>
                            <div className="grid grid-cols-1 sm:grid-cols-2" style={{ gap: 'var(--spacing-4)' }}>
