                    ...
                    {currentStep === 1 && (
                      <div className="space-y-6">
                        ...
                        {formState.constructionScope.includes('room') && (
                          <div className="bg-blue-500/10 border border-blue-400/30 rounded-xl p-6 animate-in slide-in-from-top duration-300">
                            <div className="flex items-center mb-4">
                              <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center mr-3">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="flex items-end">
                                <div className="text-sm text-slate-300">
                                  ...
                                  <p>• 일반적으로 1~4개 방이 가장 많습니다</p>
                                  <p>• 정확한 개수를 입력해주시면 더 정확한 견적을 받을 수 있습니다</p>
                                </div>
                              </div>
                            </div>
                          </div>
