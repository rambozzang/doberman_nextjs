...
export default function QuoteRequestPage() {
      ...
      <div className="min-h-screen quote-request-bg flex items-center justify-center py-12">
        ...
        >
          ...
          >
            ...
            <button
              onClick={resetForm}
              className="w-full bg-white text-gray-600 py-3 px-6 rounded-lg font-semibold hover:bg-gray-50 transition-all duration-300 border border-gray-200"
            >
              새 견적 요청하기
            </button>
          </motion.div>
  ...
  return (
    <div className="min-h-screen quote-request-bg">
      {/* 헤더 */}
      <div className="bg-slate-800/90 backdrop-blur-xl shadow-sm border-b border-slate-700/50 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="mb-4 sm:mb-0">
              <h1 className="text-3xl font-bold text-gray-900">무료 견적 요청하기</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="card-enhanced rounded-xl p-6 sticky top-8">
              <div className="mb-6">
                <h2 className="text-xl font-semibold text-gray-800 mb-2">무료 견적 요청</h2>
          ...
          <div className="lg:col-span-2">
            <div className="card-enhanced rounded-xl p-8">
                  ...
                  >
                    ...
                    <div className="mb-8">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {constructionScopes.map((scope) => (
                              ...
                              >
                                ...
                                <h4 className="font-semibold text-gray-900 mb-1">{scope.label}</h4>
                      ...
                      {currentStep === 4 && (
                        <div className="space-y-6">
                          <div>
                            <h4 className="text-lg font-semibold text-gray-900 mb-4">추가 서비스 (선택사항)</h4>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                              {additionalRequests.map((request) => (
                                ...
                                >
                                  ...
                                  <h4 className="font-semibold text-gray-900 mb-1">{request.label}</h4>
