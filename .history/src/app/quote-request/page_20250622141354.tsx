...
export default function QuoteRequestPage() {
      ...
      <div className="min-h-screen quote-request-bg flex items-center justify-center py-12">
        ...
        >
          ...
          >
            ...
            <div className="absolute top-1/2 -right-4 w-2 h-2 bg-blue-400 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
          </motion.div>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold text-lg rounded-xl shadow-xl shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-300"
            >
              홈으로 돌아가기
            </motion.button>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="w-full px-8 py-4 bg-slate-700/50 hover:bg-slate-600/60 text-white font-semibold text-lg rounded-xl border border-slate-600 hover:border-slate-500 backdrop-blur-sm transition-all duration-300"
            >
              새 견적 요청하기
            </motion.button>
          </motion.div>
  ...
  return (
    <div className="min-h-screen quote-request-bg">
        ...
        <div className="container-custom relative z-10 py-8 md:py-16">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <div className="inline-flex items-center px-3 py-2 mb-4 md:mb-6 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                <Sparkles className="w-4 h-4 text-yellow-400 mr-2" />
                <span className="text-xs md:text-sm font-medium text-white">무료 견적 서비스</span>
              </div>
              
              <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-4 md:mb-6 leading-tight px-4">
              ...
              <p className="text-sm sm:text-base md:text-xl text-blue-100 mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed px-4">
                전국 200명의 검증된 도배 전문가와 함께하는 스마트 견적 서비스
                <br className="hidden sm:block" />
                <span className="text-sm sm:text-lg text-blue-200">한 번의 신청으로 최대 5개 업체 견적 비교</span>
              </p>
              
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 text-xs md:text-sm text-blue-100 px-4">
                <div className="flex items-center">
                  <CheckIcon className="w-3 h-3 md:w-4 md:h-4 text-green-400 mr-1 md:mr-2" />
                  무료 견적
                </div>
                <div className="flex items-center">
                  <CheckIcon className="w-3 h-3 md:w-4 md:h-4 text-green-400 mr-1 md:mr-2" />
      ...
      {/* 모바일 상단 네비게이션 */}
      <div className="lg:hidden sticky top-0 z-50 bg-slate-900/90 backdrop-blur-xl border-b border-white/10">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-right">
                  <div className="text-sm font-bold text-blue-400">{Math.round(progress)}%</div>
                    ...
                    <div className="mb-6 md:mb-10">
                      ...
                      >
                        <div className="relative mb-4 sm:mb-0 sm:mr-6">
                          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/25">
                            {(() => {
                              const Icon = steps[currentStep].icon;
                          ...
                          {/* 글로우 효과 */}
                          <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl sm:rounded-2xl blur-xl opacity-30 -z-10"></div>
                        </div>
                        <div className="flex-1 w-full">
                          <div className="flex flex-col sm:flex-row sm:items-center mb-2">
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-0 sm:mr-4">{steps[currentStep].title}</h3>
                            <div className="px-3 py-1 bg-blue-500/20 border border-blue-400/30 rounded-full self-start">
                              <span className="text-xs sm:text-sm font-medium text-blue-300">
                                {currentStep + 1}/{steps.length}
                              </span>
                            </div>
                          </div>
                          <p className="text-sm sm:text-base md:text-lg text-slate-300 leading-relaxed">{steps[currentStep].description}</p>
                        </div>
                      </motion.div>
                ...
                <div className="border-t border-white/10 pt-8 mt-10">
                  <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <motion.button
                      ...
                      className={`group relative px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-xl ${
                        isLoading
