...
export default function QuoteRequestPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* 빠른 링크 섹션 */}
      <motion.section 
        className="w-full bg-gradient-to-br from-slate-900 via-blue-900/30 to-purple-900/30 pt-20 pb-6"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-blue-500/30 transition-all duration-300 cursor-pointer"
            >
            ...
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-emerald-500/30 transition-all duration-300 cursor-pointer"
            >
              <div className="flex items-center mb-4">
            ...
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-purple-500/30 transition-all duration-300 cursor-pointer"
            >
              <div className="flex items-center mb-4">
