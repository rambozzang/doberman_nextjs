                  ...
                  <div className="mb-4 sm:mb-6 md:mb-8 lg:mb-10">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center mb-3 sm:mb-4 md:mb-6">
                      <div className="relative mb-2 sm:mb-0 sm:mr-4">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/25">
                          {(() => {
                            const Icon = steps[currentStep].icon;
                      ...
                      <div className="flex-1 w-full">
                        <div className="flex flex-col sm:flex-row sm:items-center mb-1">
                          <h3 className="text-base sm:text-lg md:text-xl font-bold text-white mb-1 sm:mb-0 sm:mr-3">{steps[currentStep].title}</h3>
