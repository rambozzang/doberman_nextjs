...
export default function QuoteRequestDetailPage() {
  ...
  */
  ...
  // 채팅 파트너가 설정되고 채팅을 열어야 할 때 처리 (임시 비활성화)
  /*
  useEffect(() => {
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 text-xs text-slate-400">
                              ...
                              <span>{answer.userName || answer.user?.userName || answer.webCustomer?.customerName || "익명"}</span>
                              {answer.companyName && (
                                <>
                        ...
                        setShouldOpenChat(true);
                            ...
                            >
                              ...
                              <span className="text-sm font-bold">대화하기</span>
                            </button>
                          )}
                          */}
      ...
      {showAdoptModal && selectedAnswer && (
        ...
        <ChatModal
          ...
          onMessageChange={(value: string) => handleMessageChange({ target: { value } } as any)}
