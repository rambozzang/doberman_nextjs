            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2 px-3 py-1 bg-blue-500/20 rounded-full">
                  ...
                  <span className="text-blue-400 font-medium">{customerRequest.answerCount}개의 답변</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                {isAnswersLoading ? (
                  <div className="text-center py-8">
                    <RefreshCwIcon className="w-6 h-6 text-blue-400 animate-spin mx-auto mb-3" />
                    <div className="text-slate-400">답변을 불러오는 중...</div>
                  </div>
                ) : answers.length > 0 ? (
                  answers.map((answer, index) => (
                    <div key={answer.id} className="bg-slate-800/30 rounded-xl p-6 border border-slate-700/50 hover:border-slate-600/50 transition-all">
                  ...
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-white mb-2">아직 답변이 없습니다</h3>
                    <p className="text-slate-400">업체들의 견적 답변을 기다리고 있습니다.</p>
                  </div>
                )}
              </div>
            </div>
