    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow w-full bg-gradient-to-br from-slate-900 to-slate-800">
        <div className="container mx-auto px-4 py-8">
          ...
          {activeTab === "quotes" && (
            <div className="space-y-6">
              {quoteDetail.quotesReceived.map((quote) => (
                <div
                  key={quote.id}
                  className={`bg-white/5 backdrop-blur-xl border rounded-2xl p-6 transition-all hover:scale-105 hover:-translate-y-1 duration-300 ${
                    quote.isSelected 
