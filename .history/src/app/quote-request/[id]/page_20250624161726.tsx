            ...
            <div className="flex flex-col h-[300px]">
              <div className="flex-grow overflow-y-auto">
                {chatMessages.map((message) => (
                  <div key={message.id} className="p-2">
                    ...
                    <span className="text-slate-300 leading-relaxed">{message.message}</span>
                  </div>
                ))}
              </div>
              <div className="flex items-center gap-2 p-2">
                <input
                  ...
                  className="flex-grow p-2 bg-slate-700/50 rounded-lg"
                />
                <button
                  onClick={handleSendMessage}
                  className="p-2 bg-gradient-to-r from-blue-500/20 to-blue-600/20 hover:from-blue-500/30 hover:to-blue-600/30 rounded-lg"
                >
