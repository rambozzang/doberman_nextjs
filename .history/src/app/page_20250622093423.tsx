    ...
    <div className="main-layout">
      <div className="container-custom page-wrapper">
        ...
        <motion.div
          ...
          className="flex items-center justify-center min-h-[10vh] px-4"
        >
          <div className="relative max-w-2xl w-full">
            ...
            <div className="relative card-enhanced text-center border-gradient">
              <motion.div
                ...
                className="px-8 py-2 md:px-12 md:py-2"
              >
                {/* 이모지와 제목을 더 크게 */}
                <div className="mb-4">
                  <motion.div
                    ...
                    className="text-6xl md:text-7xl mb-2 inline-block"
                  >
                    🎯
                  </motion.div>
                ...
                <p className="text-body-lg md:text-xl text-subtle mb-5 leading-relaxed">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center justify-center gap-4 px-16 py-3 text-xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 text-white rounded-full group relative overflow-hidden shadow-2xl hover:shadow-blue-500/40 transition-all duration-300 min-w-[300px] border border-blue-400/30"
