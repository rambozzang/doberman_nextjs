        ...
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-purple-200 mb-6 leading-tight tracking-tight"
            >
              무료 도배 비교
              <br />
