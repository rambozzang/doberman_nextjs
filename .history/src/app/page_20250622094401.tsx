    ...
    <div className="main-layout">
      <div className="container-custom page-wrapper">
        ...
        <motion.div
          ...
          className="text-center px-4 py-6 sm:py-8 md:py-12 lg:py-16"
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-3 sm:mb-4 md:mb-6 text-gradient-primary leading-tight">
            무료 도배 비교 견적 서비스
          </h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-subtle mb-6 sm:mb-8 md:mb-10 max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto leading-relaxed px-2 sm:px-0">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8 md:mb-10">
            {[
              { icon: <Zap className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5" />, text: 'Next.js 15' },
              { icon: <Layers className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5" />, text: 'Zustand' },
              { icon: <Github className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5" />, text: 'TanStack Query' },
              { icon: <User className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5" />, text: 'Tailwind CSS' },
            ].map((tech, index) => (
              <motion.div
                key={tech.text}
                ...
                className="flex items-center gap-1.5 sm:gap-2 card-glass px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-full"
              >
        ...
        <motion.div
          ...
          className="px-4 py-2 md:py-12 lg:py-4"
        >
          <div className="relative max-w-2xl mx-auto lg:max-w-3xl">
            {/* 배경 글로우 효과 - 모바일에서 줄임 */}
            ...
            <div className="relative card-enhanced text-center border-gradient">
              <motion.div
                ...
                className="px-4 py-2 sm:px-6 sm:py-2 md:px-8 md:py-2 lg:px-12 lg:py-2"
              >
                {/* 이모지와 제목 - 모바일 최적화 */}
                <div className="mb-4 md:mb-6">
                  ...
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-3 md:mb-4 leading-tight">
                    무료 견적 받기
                  </h2>
                </div>
                ...
                {/* 부가 정보 - 모바일 최적화 */}
                <div className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 mt-6 md:mt-8">
                  <motion.div 
                    className="flex items-center gap-2"
                    whileHover={{ scale: 1.05 }}
                  >
                    <div className="w-2 h-2 sm:w-3 sm:h-3 bg-success rounded-full animate-pulse"></div>
                    <span className="text-xs sm:text-sm md:text-base text-muted font-medium">100% 무료</span>
                  </motion.div>
                  <motion.div 
                    className="flex items-center gap-2"
                    whileHover={{ scale: 1.05 }}
                  >
                    ...
                    <span className="text-xs sm:text-sm md:text-base text-muted font-medium">로그인 불필요</span>
                  </motion.div>
                  <motion.div 
                    className="flex items-center gap-2"
                    whileHover={{ scale: 1.05 }}
                  >
                    ...
                    <span className="text-xs sm:text-sm md:text-base text-muted font-medium">3분 소요</span>
                  </motion.div>
                </div>
              </motion.div>
            </div>
        ...
        <motion.div
          ...
          className="max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-4xl mx-auto px-4 py-8 sm:py-12 md:py-16"
        >
