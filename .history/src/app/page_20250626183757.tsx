        ...
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-purple-200 mb-6 leading-tight tracking-tight"
            >
              무료 도배 비교견적
              <br />
                  ...
                  <div className="relative flex items-center gap-2 sm:gap-3">
                    <div className={`group-hover:scale-110 transition-transform duration-300`}>
                      {React.cloneElement(tech.icon, {
                        className: `w-4 h-4 sm:w-5 sm:h-5 text-blue-400 group-hover:text-white transition-colors duration-300`,
                        style: {
                          background: `linear-gradient(to right, ${tech.gradient.includes('blue') ? '#3b82f6, #06b6d4' : tech.gradient.includes('purple') ? '#8b5cf6, #ec4899' : tech.gradient.includes('orange') ? '#f97316, #ef4444' : '#10b981, #14b8a6'})`,
