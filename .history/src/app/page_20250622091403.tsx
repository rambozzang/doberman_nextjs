      ...
      <div className="container-custom page-wrapper">
        ...
        >
          <div className="relative max-w-xl w-full">
            {/* 배경 글로우 효과 */}
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-purple-600/20 blur-2xl rounded-full"></div>
            ...
            <div className="relative card-enhanced text-center border-gradient">
              ...
              >
                ...
                <p className="text-body md:text-lg text-subtle mb-8 leading-relaxed">
                  3분만 투자하면 <span className="text-gradient-primary font-semibold">최대 5개 업체</span>의<br />
                  견적을 무료로 받아보세요
                </p>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center justify-center gap-3 px-10 py-4 text-lg font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 text-white rounded-full group relative overflow-hidden shadow-xl hover:shadow-blue-500/30 transition-all duration-300 border border-blue-400/30"
                ...
                >
                  ...
                  {/* 버튼 테두리 글로우 */}
                  <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm -z-10"></div>
                </motion.button>
