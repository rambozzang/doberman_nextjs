            ...
            <div className="relative card-enhanced text-center border-gradient">
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center justify-center gap-4 px-16 py-1 text-xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 text-white rounded-full group relative overflow-hidden shadow-2xl hover:shadow-blue-500/40 transition-all duration-300 min-w-[300px] border border-blue-400/30"
