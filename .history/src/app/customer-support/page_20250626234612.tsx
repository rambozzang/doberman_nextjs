            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {contactInfo.map((contact, index) => (
                ...
                >
                  ...
                  <p className="text-slate-300 text-l font-mono tracking-wider mb-2">{contact.value}</p>
                  ...
                  {isSubmitted ? (
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium rounded-xl shadow-lg transition-all duration-300"
                      >
                        새 문의하기
                      </motion.button>
                    </motion.div>
