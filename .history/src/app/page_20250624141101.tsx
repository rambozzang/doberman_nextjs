        ...
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-xl md:text-6xl lg:text-7xl xl:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-purple-200 mb-6 leading-tight tracking-tight"
            >
              무료 도배 비교
              <br />
