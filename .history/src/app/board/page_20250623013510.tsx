              ...
              <div className="space-y-4">
                {sortedPosts.map((post, index) => (
                  <motion.div
                    ...
                    className={`bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 cursor-pointer hover:border-white/20 transition-all duration-300 ${
              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-4">
                  <motion.button
                    ...
                    className="flex-1 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-semibold rounded-xl shadow-lg transition-all duration-300"
                  >
                    게시글 등록
                  </motion.button>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={() => setIsWriting(false)}
                    className="px-8 py-3 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl border border-white/20 hover:border-white/40 transition-all duration-300"
                  >
                    취소
                  </motion.button>
                </div>
