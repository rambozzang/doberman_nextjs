                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={15}
                      className={`w-full px-4 py-4 bg-white/10 border rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 transition-all duration-300 resize-none ${
                        errors.content 
                          ? 'border-red-400 focus:border-red-400 focus:ring-red-400/20' 
                          : 'border-white/20 focus:border-indigo-400 focus:ring-indigo-400/20'
                      }`}
