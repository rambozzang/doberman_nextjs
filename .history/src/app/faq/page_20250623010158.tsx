...
import { ChevronDownIcon, ChevronUpIcon, SearchIcon, HelpCircleIcon, CheckCircleIcon, ClockIcon, CreditCardIcon, ShieldCheckIcon, HomeIcon, PhoneIcon } from "lucide-react";
    ...
    questions: [
      {
        ...
        answer: "아파트 기준으로 거실 1일, 방 1개당 반나절~1일 정도 소요됩니다. 전체 도배의 경우 20평대 아파트는 2-3일, 30평대는 3-4일 정도 예상하시면 됩니다."
      },
      {
        id: "construction-2",
    ...
    questions: [
      {
        ...
        answer: "결제는 선택하신 전문가와 직접 진행하시면 됩니다. 현금, 계좌이체, 카드결제 등 전문가별로 가능한 결제방법이 다르니 미리 확인해주세요."
      },
      {
        id: "payment-2",
        question: "중간 결제나 선불 결제가 필요한가요?",
        answer: "일반적으로 시공 완료 후 결제하시면 됩니다. 대규모 공사의 경우 중간금이 필요할 수 있으니 전문가와 미리 협의해주세요. 선불 결제는 권하지 않습니다."
      },
      {
        id: "payment-3",
        question: "현금영수증이나 세금계산서 발행 가능한가요?",
        answer: "대부분의 전문가들이 현금영수증 및 세금계산서 발행이 가능합니다. 필요하시다면 견적 문의 시 미리 말씀해주세요."
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "시공 후 1년간 품질보증이 적용됩니다. 벽지 들뜸, 기포, 이음매 불량 등의 문제 발생 시 무상 A/S를 받으실 수 있습니다."
      },
      {
        id: "warranty-2",
        question: "도배르만에서 품질을 보장하나요?",
        answer: "도배르만은 검증된 전문가만을 등록하며, 지속적인 품질 관리를 통해 서비스 품질을 보장합니다. 또한 고객 리뷰 시스템을 통해 투명한 평가가 이루어집니다."
      },
      {
        id: "warranty-3",
        question: "전문가들은 어떻게 선별되나요?",
        answer: "경력 3년 이상, 관련 자격증 보유, 보험 가입 여부, 고객 만족도 등을 종합적으로 심사하여 선별합니다. 또한 정기적인 재심사를 통해 품질을 유지합니다."
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "고객센터는 평일 오전 9시부터 오후 6시까지 운영됩니다. 토요일은 오전 10시부터 오후 3시까지 운영하며, 일요일 및 공휴일은 휴무입니다."
      },
      {
        id: "contact-2",
        question: "긴급한 문의는 어떻게 하나요?",
        answer: "시공 중 긴급상황이나 분쟁 발생 시에는 24시간 긴급상담 전화(1588-0000)로 연락주시면 즉시 대응해드립니다."
      },
      {
        id: "contact-3",
        question: "전문가와 연락이 안 될 때는 어떻게 하나요?",
        answer: "전문가와 연락이 어려우실 때는 도배르만 고객센터로 연락주세요. 저희가 직접 전문가에게 연락하여 신속하게 해결해드립니다."
      }
    ]
  }
];
