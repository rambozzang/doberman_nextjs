  ...
  return (
    <div className="main-layout">
      <div className="container mx-auto page-wrapper">
        ...
        {/* 도배업체명 스크롤 섹션 - 헤더 바로 아래 */}
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="h-20 bg-slate-900/50 backdrop-blur-sm border-b border-slate-700/30 overflow-hidden relative"
        >
        ...
        <motion.div
          ...
          className="relative text-center px-4 py-8 sm:py-12 md:py-16 lg:py-20 overflow-hidden"
        >
          {/* 배경 장식 요소들 */}
